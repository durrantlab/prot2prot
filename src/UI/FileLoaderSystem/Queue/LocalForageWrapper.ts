...
export function jsZipAndFileSaverPromises(existingModulePromises: Promise<any>[] = undefined): Promise<any> {
    // Note that jszip has to be relative path. "jszip" works in
    // vuejs_components, but not in binana. Best to keep relative for broadest
    // compatibility. Very strange I was never able to figure this out.
