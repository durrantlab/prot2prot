...
PATH = "./size_256_full/"
CHECKPOINT_DIR = "./training_checkpoints_256_full_v2"
...
def Generator():
    ...
    up_stack = [
        upsmpl(512, 4, apply_dropout=True, layer_name="upsample1"),  # (batch_size, 2, 2, 1024)
        upsmpl(512, 4, apply_dropout=True, layer_name="upsample2"),  # (batch_size, 4, 4, 1024)
        upsmpl(512, 4, apply_dropout=True, layer_name="upsample3"),  # (batch_size, 8, 8, 1024)
        upsmpl(512, 4, layer_name="upsample4"),  # (batch_size, 16, 16, 1024)
        upsmpl(256, 4, layer_name="upsample5"),  # (batch_size, 32, 32, 512)
        upsmpl(128, 4, layer_name="upsample6"),  # (batch_size, 64, 64, 256)
        upsmpl(64, 4, layer_name="upsample7"),  # (batch_size, 128, 128, 128)
    ]
