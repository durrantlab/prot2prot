...
PATH = "./size_64_full/"
CHECKPOINT_DIR = "./training_checkpoints_64.no_norm.v4"
...
def Generator():
    ...
    down_stack = [
        ...
        # the browser.
        downsample(512, 4, apply_batchnorm=False, apply_layernorm=True, layer_name="downsample6"),  # (batch_size, 1, 1, 512)
    ]
