...
PATH = "./size_128_full/"
CHECKPOINT_DIR = "./training_checkpoints_128.no_norm.v4"
...
def Generator():
    ...
    down_stack = [
        ...
        # the browser.
        downsample(512, 4, apply_batchnorm=False, apply_layernorm=True, layer_name="downsample7"),  # (batch_size, 1, 1, 512)
    ]
