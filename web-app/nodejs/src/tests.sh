rm -rf tests
mkdir -p tests/single
mkdir -p tests/rock
mkdir -p tests/turn_table
mkdir -p tests/zoom

node render_single.js -p ../5iy4.pdb -o tests/single/out.png --x_rot 0.5 --y_rot 1.0 --z_rot .75 --dist 100 --debug --mode both --color FF0000 --color_strength 0.25 --color_blend 2
